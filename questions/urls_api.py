...
urlpatterns = [
    ...
    path('questions/<int:pk>/answers/',
         views.Answer_list.as_view(), name='question-answers'),
    path('questions/<int:qid>/answers/<int:pk>/',
         views.Answer_detail.as_view(), name='answer-detail'),
    ...
    path('tags/<str:name>/questions/',
         views.Tags_questions.as_view(), name='tag-question-detail'),

    # reply api
    path('replies/<int:pk>/', views.Reply_detail.as_view(),
         name='reply-detail'),

    # path('questions/<int:pk>/reactions/',
    # views.QuestionReaction_list.as_view(),name='question-reactions'),
    # question reaction api
    # path('questionreactions/<int:pk>/',
    # views.QuestionReaction_detail.as_view(),name="questionreaction-detail"),

    # question tag api
    # path('questions/<int:pk>/tags/', views.QuestionTag_list.as_view(),
    # name='question-tags'),
    # path('questiontags/<int:pk>/', views.QuestionTag_detail.as_view(),
    # name ='questiontag-detail'),
