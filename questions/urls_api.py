...
urlpatterns = [
    ...
    path('questions/<int:pk>/questionreactions/',views.QuestionReaction_list.as_view(),name='question-reactions'),
    ...
    # question tag api
    path('questions/<int:pk>/questiontags/', views.QuestionTag_list.as_view(),name='question-tags'),
